...
class PokedexSpecies
{
    ...
    /**
     * @var PokemonSpecies
     * @ORM\ManyToOne(targetEntity="App\Entity\Pokemon\PokemonSpecies", inversedBy="pokedexSpecies")
    ...
    /**
     * @var Pokedex
     * @ORM\ManyToOne(targetEntity="App\Entity\Pokedex\Pokedex", inversedBy="pokedexSpecies")
