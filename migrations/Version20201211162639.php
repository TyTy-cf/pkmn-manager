 ...
 */
final class Version20201211162639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE evolution_chain (id INT AUTO_INCREMENT NOT NULL, evolve_to_pokemon_species_id INT DEFAULT NULL, current_pokemon_species_id INT DEFAULT NULL, evolution_detail_id INT DEFAULT NULL, INDEX IDX_68B112687D66DE33 (evolve_to_pokemon_species_id), INDEX IDX_68B11268ACC5F3FC (current_pokemon_species_id), INDEX IDX_68B112682C2C0E8 (evolution_detail_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evolution_detail (id INT AUTO_INCREMENT NOT NULL, gender_id INT DEFAULT NULL, held_item_id INT DEFAULT NULL, used_item_id INT DEFAULT NULL, known_move_id INT DEFAULT NULL, known_move_type_id INT DEFAULT NULL, pokemon_species_id INT DEFAULT NULL, party_type_id INT DEFAULT NULL, evolution_trigger_id INT DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, min_affection VARCHAR(255) DEFAULT NULL, min_beauty VARCHAR(255) DEFAULT NULL, min_happiness VARCHAR(255) DEFAULT NULL, min_level VARCHAR(255) DEFAULT NULL, needs_overworld_rain VARCHAR(255) DEFAULT NULL, time_of_day VARCHAR(255) DEFAULT NULL, relative_physical_stats VARCHAR(255) DEFAULT NULL, INDEX IDX_16070E5D708A0E0 (gender_id), INDEX IDX_16070E5DBD59BEFF (held_item_id), INDEX IDX_16070E5D95B877AF (used_item_id), INDEX IDX_16070E5D189A45FC (known_move_id), INDEX IDX_16070E5D40D850A6 (known_move_type_id), INDEX IDX_16070E5D609DB477 (pokemon_species_id), INDEX IDX_16070E5DD7BD13B8 (party_type_id), INDEX IDX_16070E5DAD65CE5B (evolution_trigger_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE evolution_trigger (id INT AUTO_INCREMENT NOT NULL, language_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_668FE19B82F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE generation (id INT AUTO_INCREMENT NOT NULL, language_id INT DEFAULT NULL, number VARCHAR(2) NOT NULL, code VARCHAR(2) NOT NULL, name VARCHAR(120) DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_D3266C3B82F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE move_learn_method (id INT AUTO_INCREMENT NOT NULL, language_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_EF1CDB882F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE move_machine (id INT AUTO_INCREMENT NOT NULL, move_id INT DEFAULT NULL, version_group_id INT DEFAULT NULL, language_id INT DEFAULT NULL, image_url VARCHAR(255) NOT NULL, cost INT NOT NULL, name VARCHAR(120) DEFAULT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_E7C819D36DC541A8 (move_id), INDEX IDX_E7C819D392AE854F (version_group_id), INDEX IDX_E7C819D382F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokedex (id INT AUTO_INCREMENT NOT NULL, region_id INT DEFAULT NULL, language_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_6336F6A798260155 (region_id), INDEX IDX_6336F6A782F1BAF4 (language_id), INDEX slug_idx (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon_form (id INT AUTO_INCREMENT NOT NULL, pokemon_id INT DEFAULT NULL, language_id INT DEFAULT NULL, is_mega TINYINT(1) DEFAULT NULL, is_default TINYINT(1) DEFAULT NULL, is_battle_only TINYINT(1) DEFAULT NULL, form_name VARCHAR(255) DEFAULT NULL, form_sprite VARCHAR(255) DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_6E21830C2FE71C3E (pokemon_id), INDEX IDX_6E21830C82F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon_species (id INT AUTO_INCREMENT NOT NULL, evolves_from_species_id INT DEFAULT NULL, generation_id INT DEFAULT NULL, language_id INT DEFAULT NULL, base_happiness INT DEFAULT NULL, capture_rate INT DEFAULT NULL, growth_rate VARCHAR(255) DEFAULT NULL, hatch_counter INT DEFAULT NULL, is_legendary SMALLINT DEFAULT NULL, has_gender_differences SMALLINT DEFAULT NULL, is_mythical SMALLINT DEFAULT NULL, is_baby SMALLINT DEFAULT NULL, genera VARCHAR(255) DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_C9658B837D11D524 (evolves_from_species_id), INDEX IDX_C9658B83553A6EC4 (generation_id), INDEX IDX_C9658B8382F1BAF4 (language_id), INDEX slug_idx (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE species_evolution (id INT AUTO_INCREMENT NOT NULL, pokemon_species_id INT DEFAULT NULL, evolution_chain_id INT DEFAULT NULL, INDEX IDX_12EF986D609DB477 (pokemon_species_id), INDEX IDX_12EF986DE417AC09 (evolution_chain_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE version_group (id INT AUTO_INCREMENT NOT NULL, generation_id INT DEFAULT NULL, language_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_6A1C90C0553A6EC4 (generation_id), INDEX IDX_6A1C90C082F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evolution_chain_evolution_chain DROP FOREIGN KEY FK_52868A8183CBC7AA');
        $this->addSql('ALTER TABLE evolution_chain_evolution_chain DROP FOREIGN KEY FK_52868A819A2E9725');
