...
final class Version20201128005556 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stats_evs_pkmn (id INT AUTO_INCREMENT NOT NULL, hp INT DEFAULT NULL, atk INT DEFAULT NULL, def INT DEFAULT NULL, spa INT DEFAULT NULL, spd INT DEFAULT NULL, spe INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE moves ADD CONSTRAINT FK_453F08329883C12E FOREIGN KEY (damage_class_id) REFERENCES damage_class (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE moves DROP FOREIGN KEY FK_453F08329883C12E');
