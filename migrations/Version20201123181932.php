 ...
 */
final class Version20201123181932 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, url_img VARCHAR(255) DEFAULT NULL, url_img_shiny VARCHAR(255) DEFAULT NULL, hp INT NOT NULL, atk INT NOT NULL, def INT NOT NULL, spa INT NOT NULL, spd INT NOT NULL, spe INT NOT NULL, name_en VARCHAR(24) NOT NULL, name_fr VARCHAR(24) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type (id INT AUTO_INCREMENT NOT NULL, img VARCHAR(255) DEFAULT NULL, name_en VARCHAR(24) NOT NULL, name_fr VARCHAR(24) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
