 ...
 */
final class Version20201129114349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE generation (id INT AUTO_INCREMENT NOT NULL, language_id INT DEFAULT NULL, code VARCHAR(2) NOT NULL, name VARCHAR(36) DEFAULT NULL, slug VARCHAR(36) DEFAULT NULL, INDEX IDX_D3266C3B82F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, stats_effort_id INT DEFAULT NULL, language_id INT DEFAULT NULL, url_icon VARCHAR(255) DEFAULT NULL, url_sprite_img VARCHAR(255) DEFAULT NULL, weight INT DEFAULT NULL, height INT DEFAULT NULL, hp INT DEFAULT NULL, atk INT DEFAULT NULL, def INT DEFAULT NULL, spa INT DEFAULT NULL, spd INT DEFAULT NULL, spe INT DEFAULT NULL, name VARCHAR(36) DEFAULT NULL, slug VARCHAR(36) DEFAULT NULL, INDEX IDX_62DC90F373CEECA (stats_effort_id), INDEX IDX_62DC90F382F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE version_group (id INT AUTO_INCREMENT NOT NULL, generation_id INT DEFAULT NULL, language_id INT DEFAULT NULL, name VARCHAR(36) DEFAULT NULL, slug VARCHAR(36) DEFAULT NULL, INDEX IDX_6A1C90C0553A6EC4 (generation_id), INDEX IDX_6A1C90C082F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pokemon_moves_learn_version ADD CONSTRAINT FK_7364724FB5C0D298 FOREIGN KEY (gameinfos_id) REFERENCES version_group (id)');
